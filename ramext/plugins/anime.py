...
CmdHelp("anime").add_command(
  ...
  "manga", "<manga name>", "Searches for the given manga and sends the details."
).add_command(
  "character", "<character name>", "Searches for the given anime character and sends the details."
).add_command(
  "aniuser", "<anilist username>", "Searches for the Anilist Stats of the given user."
).add_command(
