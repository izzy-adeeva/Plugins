...
CmdHelp("getpfp").add_command(
  "poto", "<all> / <desired pfp number>", f"Reply to user to get his/her profile pic. Use {ii}poto <number> to get desired profile pic else use {ii}poto all to get all profile pic(s). If you dont reply to a user then it gets group pics."
).add_command(
