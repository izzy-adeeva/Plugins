    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await event.client.send_file(
                event.chat_id,
                directory_name + ".7z",
                caption="7z archived By ramubot",
                force_document=True,
                allow_cache=False,
                reply_to=event.message.id,
            )
