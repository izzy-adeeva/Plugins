...
from ramext.sql.fsub_sql import *
from . import *
...
async def _(event):
    ...
    if uid == event.sender_id:
        ...
        try:
            ...
            await RAM2(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await RAM3(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await RAM4(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await RAM5(GetParticipantRequest(int(joinchat), uid))
        except Exception:
        ...
        try:
            ...
            await RAM2.edit_permissions(event.chat.id, uid, until_date=None, send_messages=True)
        except Exception:
            await RAM3.edit_permissions(event.chat.id, uid, until_date=None, send_messages=True)
        except Exception:
            await RAM4.edit_permissions(event.chat.id, uid, until_date=None, send_messages=True)
        except Exception:
            await RAM5.edit_permissions(event.chat.id, uid, until_date=None, send_messages=True)
        except Exception:
