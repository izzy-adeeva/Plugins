...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "")
    MY_GROUP = os.environ.get("YOUR_GROUP", "")
    ...
    PMPERMIT_PIC = os.environ.get(
        "PMPERMIT_PIC", "https://telegra.ph/file/e62dcb31e02594af0fab4.png"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "RamBot")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    TZ = os.environ.get("TZ", "Asia/Jakarta")
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/izzy-adeeva/Plugins"
    )
