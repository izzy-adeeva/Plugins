...
async def carbon_api(e):
    ...
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by RAM-UBOT Extended",
        force_document=True,
...
async def carbon_api(e):
    ...
    await TOD.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await TOD.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
