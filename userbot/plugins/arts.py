...
@ram_cmd(pattern="carry ([\s\S]*)")
async def iraa(carry):
...
@ram_cmd(pattern="ded ([\s\S]*)")
async def iraa(event):
...
@ram_cmd(pattern="strump ([\s\S]*)")
async def iraa(trumpsay):
...
@ram_cmd(pattern="schina ([\s\S]*)")
async def iraa(ckmkb):
...
@ram_cmd(pattern="shitos$")
async def _(shitos):
    await eor(shitos, S)


@ram_cmd(pattern="dislike$")
async def _(dislike):
    await eor(dislike, T)
