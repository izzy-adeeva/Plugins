...
async def hmm(TOD):
    ...
    await eor(TOD, reactcat)


@ram_cmd(pattern="why$")
async def hmm(TOD):
    whyhell = nekos.why()
    await eor(TOD, whyhell)


@ram_cmd(pattern="fact$")
async def hmm(TOD):
    facthell = nekos.fact()
    await eor(TOD, facthell)
