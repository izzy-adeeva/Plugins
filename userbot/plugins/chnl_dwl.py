...
async def get_media(event):
    ...
    TOD = await eor(event, "Downloading Media From this Channel.")
    ...
    await TOD.edit("Downloaded " + output + " files.")
...
async def get_media(event):
    ...
    print(channel_username)
    TOD = await eor(event, "Downloading All Media From this Channel.")
