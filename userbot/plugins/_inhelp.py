...
RAM_PIC = Config.PMPERMIT_PIC or "https://telegra.ph/file/58df4d86400922aa32acd.jpg"
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        auth = await clients_list(Config, TOD, TOD2, TOD3, TOD4, TOD5)
        if event.query.user_id in auth and query == "userbot_help":
            ...
            ibel = alive_txt.format(alv_msg, tel_ver, ram_ver, uptime, abuse_m, is_sudo)
            alv_btn = [
            ...
            result = builder.article(
                ...
                buttons=[
                    [Button.url(" Repo ", "https://github.com/The-RamBot/RamBot")],
                    [
                        Button.url(
                            " Deploy ",
                            "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Fhitokizzy%2FRAM-UBOT-EXT&template=https%3A%2F%2Fgithub.com%2Fhitokizzy%2FRAM-UBOT-EXT",
                        )
                    ],
                ],
            )
            ...
            result = builder.article(
                "RAM-UBOT EXTENDED",
                text="""**Hey! This is [RAM-UBOT Extended](https://t.me/ramsupport) \nYou can know more about me from the links given below **""",
                buttons=[
                    [
                        custom.Button.url(" CHANNEL ", "https://t.me/ramsupport"),
                        custom.Button.url(" GROUP ", "https://t.me/ramsupportt"),
                    ],
                    [
                        custom.Button.url(
                            " REPO ", "https://github.com/hitokizzy/RAM-UBOT-EXT"
                        ),
