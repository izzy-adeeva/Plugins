...
@ramm.on(admin_cmd(pattern="afk(?:\s|$)([\s\S]*)"))
async def _(event):
    if event.fwd_from:
        return
...
if TOD2:
    ...
    @TOD2.on(events.NewMessage(outgoing=True))
    async def set_not_afk(event):
        global afk_time
        global last_afk_message
        global afk_start
    ...
    @TOD2.on(admin_cmd(pattern="afk(?:\s|$)([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
...
if TOD3:
    ...
    @TOD3.on(events.NewMessage(outgoing=True))
    async def set_not_afk(event):
        global afk_time
        global last_afk_message
        global afk_start
    ...
    @TOD3.on(admin_cmd(pattern="afk(?:\s|$)([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
...
if TOD4:
    ...
    @TOD4.on(events.NewMessage(outgoing=True))
    async def set_not_afk(event):
        global afk_time
        global last_afk_message
        global afk_start
    ...
    @TOD4.on(admin_cmd(pattern="afk(?:\s|$)([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
...
if TOD5:
    ...
    @TOD5.on(events.NewMessage(outgoing=True))
    async def set_not_afk(event):
        global afk_time
        global last_afk_message
        global afk_start
    ...
    @TOD5.on(admin_cmd(pattern="afk(?:\s|$)([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
