...
from userbot.sql.fsub_sql import *
...
async def _(event):
    ...
    if uid == event.sender_id:
        ...
        try:
            await ramm(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await TOD2(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await TOD3(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await TOD4(GetParticipantRequest(int(joinchat), uid))
        except Exception:
            await TOD5(GetParticipantRequest(int(joinchat), uid))
        except Exception:
