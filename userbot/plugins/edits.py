...
async def _(event):
    ...
    if input_str == "shrug":
        ...
        TOD = await eor(event, input_str)
        animation_chars = [":\\", ":/"]
        for i in animation_ttl:
            await asyncio.sleep(animation_interval)
            await TOD.edit(animation_chars[i % 2])
    elif input_str == "-_-":
        TOD = await eor(event, input_str)
...
@ram_cmd(pattern=f"shrug$")
async def metoo(e):
    txt = random.choice(SHRUG)
    await eor(e, txt)


@ram_cmd(pattern=f"dogge")
async def metoo(e):
    txt = random.choice(DOG)
    await eor(e, txt)


@ram_cmd(pattern=f"mesed$")
async def metoo(e):
    txt = random.choice(SED)
    await eor(e, txt)


@ram_cmd(pattern=f"medead$")
async def metoo(e):
    txt = random.choice(DEAD)
    await eor(e, txt)


@ram_cmd(pattern=f"confused$")
async def metoo(e):
    txt = random.choice(CONFUSED)
    await eor(e, txt)


@ram_cmd(pattern=f"lobb$")
async def metoo(e):
    txt = random.choice(LOB)
    await eor(e, txt)


@ram_cmd(pattern=f"wut$")
async def metoo(e):
    txt = random.choice(WTF)
    await eor(e, txt)


@ram_cmd(pattern=f"wavee$")
async def metoo(e):
    txt = random.choice(WAVING)
    await eor(e, txt)


@ram_cmd(pattern=f"hehe$")
async def metoo(e):
