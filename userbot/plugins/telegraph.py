...
async def _(event):
    ...
    TOD = await eor(event, "Making Telegraph Link....")
    ...
    if event.reply_to_msg_id:
        ...
        await eod(TOD, "Reply to a message to get a permanent telegra.ph link.")
